...
class ModelLinkage(Component):
    ...
    def __init__(self, parent, position, shaderProg, display_obj=None):
        ...
        rightArmBlock2 = Cube(Point((0, -0.05, 0)), shaderProg, [0.1, 0.1, 0.1], Ct.BLACK)
        rightArmJoint3 = Sphere(Point((0, -0.05, 0)), shaderProg, [0.01, 0.01, 0.01], Ct.BLACK)
        rightArmBlock3 = Cube(Point((0, -0.05, 0)), shaderProg, [0.1, 0.1, 0.1], Ct.BLACK)
        ...
        rightArmJoint2.setRotateExtent(self.wAxis, 0, 0)
        rightArmJoint3.setRotateExtent(self.uAxis, -30, 0)
        rightArmJoint3.setRotateExtent(self.vAxis, 0, 0)
        rightArmJoint3.setRotateExtent(self.wAxis, 0, 0)

        leftFoot.setRotateExtent(self.uAxis, 0, 15)
        leftFoot.setRotateExtent(self.vAxis, -15, 15)
        leftFoot.setRotateExtent(self.wAxis, 0, 0)
        rightFoot.setRotateExtent(self.uAxis, 0, 15)
